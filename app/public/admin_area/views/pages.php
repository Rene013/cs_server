                ...
                <table class="table table-striped table-hover">
                      <tr>
                        ...
                        <tr>
							...
							<td><a href="index.php?page=edit&id=<?php echo $list['id']; ?>"><p><?php echo ($blurb == " ") ? "edit" : $blurb; ?></p></a></td>
    ...
    <div class="modal fade" id="addPage" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" style="z-index: 1101;">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<form action="index.php?page=edit" method="post" role="form">
					...
					<div class="modal-body">
						...
						<div class="form-group">
							...
							<textarea rows="20" name="page-body" class="form-control" placeholder="Page Body"></textarea>
						</div>
						<div class="checkbox">
							<label>
