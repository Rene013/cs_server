...
<title>Betop Web Crawler tools</title>
...
<?php 
	...
	function showsites($message=null) {
		global $mysql_table_prefix;
		$result = mysql_query($connection,"SELECT site_id, url, title, indexdate from ".$mysql_table_prefix."sites ORDER By indexdate, title");
		echo mysqli_error();
		?>
		<div id='submenu'>
		 <ul>
