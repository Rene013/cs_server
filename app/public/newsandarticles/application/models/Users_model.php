...
class Users_model extends MY_Model {
	...
	public function register(){
			...
			$user_data = [
						...
						'auth_level'	=>	$this->input->post('auth_level'), // 9 if you want to login @ user/index.
						'created_at'	=>	date('Y-m-d H:i:s')
				];
			// Insert user
			return $this->db->set($user_data)->insert(db_table('user_table')) ? true : false;
		}
	// --------------------------------------------------------------
	
	public function login($user_string) {
