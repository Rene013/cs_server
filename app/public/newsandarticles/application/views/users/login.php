	...
	<div class="row">
		<div class="col-md-4 col-md-offset-4">
			...
			<div class="form-group">
				...
				<input type="text" name="login_string" id="login_string" class="form_input form-control" placeholder="Enter Username" autofocus autocomplete="off" maxlength="255">
			</div>
			<div class="form-group">
				<label for="login_pass" class="form_label">Password</label>
			
				<input type="password" name="login_pass" id="login_pass" class="form_input form-control password" 
				
				<?php 
					if( config_item('max_chars_for_password') > 0 )
						echo 'maxlength="' . config_item('max_chars_for_password') . '"'; 
				?> autocomplete="off" readonly="readonly" onfocus="this.removeAttribute('readonly');" placeholder="Enter Password" required autofocus>
			...
			<div class ="form-group">
				...
				?>
					...
					<label for="remember_me" class="form_label text-center">Remember Me</label>
