<div class="row">
	<div class="col-md-12" id="searchForm">
		<form role="search" class="searchform" action="search.php" method="get">
			<div class="input-group">
				<input type="text" name="query" id="query" size="40" placeholder="search" value="<?php   print quote_replace($query);?>" action="include/js_suggest/suggest.php" columns="2" class="form-control searchKeywords" autocomplete="off" delay="1500">
				<span class="input-group-btn">
				<button type="submit" class="btn btn-default btn-search"value="<?php print $sph_messages['Search']?>">
				...
				<?php  }?>
				<input type="hidden" name="search" id="siteid" value="1">
